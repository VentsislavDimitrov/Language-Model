...
if __name__ == "__main__":
    ...
    if train_model.classification_mode:
    ...
    # with no_grad():
    #     train_loss_loader = train_loss.calculate_loss_of_loader()
    #     validation_loss_loader = validation_loss.calculate_loss_of_loader()
    # info(f"Train Loss: {train_loss_loader}")
    # info(f"Validation Loss: {validation_loss_loader}")
    #
    gpt_model.eval()
